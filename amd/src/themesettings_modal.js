    ...
    function(jQuery, Notification, CustomEvents, Modal, ModalRegistry, Ajax) {
        ...
        var ThemeSettingsModal = function(root) {
            ...
            var request = Ajax.call([{
                methodname: 'theme_biossex_getthemesettings',
                args: {}
            }]);
        ...
        ThemeSettingsModal.TYPE = 'theme_biossex-themesettings_modal';
        ...
        ThemeSettingsModal.prototype.registerEventListeners = function() {
            ...
            this.getModal().on(CustomEvents.events.activate, SELECTORS.SAVE_BUTTON, function() {
                var request = Ajax.call([{
                    methodname: 'theme_biossex_savethemesettings',
                    args: {
        ...
        if (!registered) {
            ModalRegistry.register(ThemeSettingsModal.TYPE, ThemeSettingsModal, 'theme_biossex/themesettings_modal');
            registered = true;
        }
