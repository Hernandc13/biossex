...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function render_lang_menu() {
        ...
        if ($haslangmenu) {
            ...
            if (isset($context)) {
                return $this->render_from_template('theme_biossex/lang_menu', $context);
            }
        }
    }
    ...
    public function get_logo_vac() {
        if ($this->should_display_theme_logo_vacant()) {
            return $this->get_theme_logo_url_vacantImg();
        }
    ...
    public function get_pix_image_url_base() {
        ...
        return $CFG->wwwroot . "/theme/biossex/pix";
    }
     ...
     * @return bool
     */
    public function should_display_theme_logo_vacant() {
        $vacant = $this->get_theme_logo_url_vacantImg();
    ...
    public function get_theme_logo_url_vacantImg() {
        $theme = theme_config::load('biossex');

        return $theme->setting_file_url('vacantimg', 'vacantimg');
    }
    /**
    ...
    public function user_menu($user = null, $withlinks = null) {
        ...
        if (!isloggedin()) {
            ...
            return $this->render_from_template('theme_biossex/frontpage_guest_loginbtn', $context);
        }
    ...
    public function render_help_icon(help_icon $helpicon) {
        ...
        // Check issue https://github.com/willianmano/moodle-theme_biossex/issues/5.
    ...
    public function search_box($identifier = false) {
        ...
        return html_writer::tag('div',
                                ...
                                array('class' => 'biossex-search-input nav-link', 'id' => $identifier));
    }
    ...
    public function breadcrumb_header() {
        ...
        if ($this->page->pagelayout == 'mypublic') {
            $header->contextheader = "<h2>". get_string('userprofile', 'theme_biossex') ."</h2>";
        }

        return $this->render_from_template('theme_biossex/breadcrumb', $header);
    }
    ...
    public function body_attributes($additionalclasses = array()) {
        $hasaccessibilitybar = get_user_preferences('themebiossexsettings_enableaccessibilitytoolbar', '');
        ...
        $fonttype = get_user_preferences('themebiossexsettings_fonttype', '');
        if ($fonttype) {
