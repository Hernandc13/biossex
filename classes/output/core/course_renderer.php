...
namespace theme_biossex\output\core;
...
use theme_biossex\util\extras;

/**
 * Renderers to align biossex's course elements to what is expect
 *
 * @package    theme_biossex
...
class course_renderer extends \core_course_renderer {
    ...
    protected function coursecat_courses(coursecat_helper $chelper, $courses, $totalcount = null) {
        ...
        $theme = \theme_config::load('biossex');
    ...
    protected function course_card_footer(core_course_list_element $course) {
        ...
        if (isloggedin()) {
            ...
            $content .= html_writer::link(new moodle_url('/course/view.php', ['id' => $course->id]),
                get_string('access', 'theme_biossex'), ['class' => 'card-link btn']);
