...
namespace theme_biossex\privacy;
...
/**
 * The biossex theme does not store any data.
 *
 * @copyright  2018 Willian Mano - http://conecti.me
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class provider implements
    ...
    const FONTTYPE = 'themebiossexsettings_fonttype';
    /** The user preference for the enable accessibility toolbar. */
    const TOOLBAR = 'themebiossexsettings_enableaccessibilitytoolbar';
    ...
    public static function get_metadata(collection $items) : collection {
        ...
        $items->add_user_preference(self::FONTTYPE, 'privacy:metadata:preference:themebiossexsettings_fonttype');
        $items->add_user_preference(self::TOOLBAR, 'privacy:metadata:preference:themebiossexsettings_enableaccessibilitytoolbar');
        return $items;
    }
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($toolbar)) {
            writer::export_user_preference(
                ...
                self::TOOLBAR,
                $toolbar,
                get_string('privacy:themebiossexsettings_enableaccessibilitytoolbar', 'theme_biossex', $toolbar)
            );
            ...
            if (isset($fontsize)) {
                writer::export_user_preference(
                    ...
                    self::FONTSIZE,
                    $fontsize,
                    get_string('privacy:accessibilitystyles_fontsizeclass', 'theme_biossex', $fontsize)
                );
            }
            ...
            if (isset($sitecolor)) {
                writer::export_user_preference(
                    ...
                    self::SITECOLOR,
                    $sitecolor,
                    get_string('privacy:accessibilitystyles_sitecolorclass', 'theme_biossex', $sitecolor)
                );
            }
        }
        ...
        if (isset($fonttype)) {
            writer::export_user_preference(
                ...
                self::FONTTYPE,
                $fonttype,
                get_string('privacy:themebiossexsettings_fonttype', 'theme_biossex', $fonttype)
            );
        }
    }
}
