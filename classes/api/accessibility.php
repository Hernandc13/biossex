...
class accessibility extends external_api {
    ...
    public static function savethemesettings($formdata) {
        ...
        if ($data['fonttype'] && in_array($data['fonttype'], ['default', 'odafont'])) {
            ...
            set_user_preference('themebiossexsettings_fonttype', $fonttype);
        }
        ...
        set_user_preference('themebiossexsettings_enableaccessibilitytoolbar', $enableaccessibilitytoolbar);

        \core\notification::success(get_string('themesettinggsavedsuccessfully', 'theme_biossex'));
    ...
    public static function getthemesettings() {
        return [
            'fonttype' => get_user_preferences('themebiossexsettings_fonttype', 'default'),
            'enableaccessibilitytoolbar' => get_user_preferences('themebiossexsettings_enableaccessibilitytoolbar', false)
        ];
    }
