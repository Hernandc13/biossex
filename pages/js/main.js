...
const UIController = (function() {
    ...
    return {
        ...
        createTrackDetail(img, title, artist) {
            ...
            const html = 
            `
            <div class="row col-sm-12 px-0 imagencd">
                <img src="${img}" alt="" style="position: relative; left: 7em; top: 2em; height: 17em; width: 16em;">
                <iframe style="border-radius:12px; position: relative; bottom: -3em; right: -100%;" src="https://open.spotify.com/embed/album/6ID17PzjagQlFsc1KFha5v?utm_source=generator" width="100%" height="80" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
            </div>
            <div class="row col-sm-12 px-0">
                <label for="Genre" class="form-label col-sm-12" style="position: relative; right: 2em; top: -12em;">${title}:</label>
            </div>
            <div class="row col-sm-12 px-0">
                <label for="artist" class="form-label col-sm-12" style="position: relative; right: 2em; top: -11em">By ${artist}:</label>
            </div>
            `;
