...
$string['choosereadme'] = 'biossex é um tema moderno e altamente customizável. Este tema tem por objetivo ser usado diretamente, ou como um tema pai quando criados novos temas utilizando Bootstrap 4.';
...
$string['cachedef_fontawesomebiossexiconmapping'] = 'Definição de cache dos ícones do tema';
...
$string['privacy:metadata:preference:themebiossexsettings_fonttype'] = 'Preferências do usuário para tipo de fonte.';
$string['privacy:metadata:preference:themebiossexsettings_enableaccessibilitytoolbar'] = 'Preferências do usuário para habilitar a barra de acessibilidade.';
...
$string['privacy:themebiossexsettings_fonttype'] = 'A preferência atual para o tipo de fonte é: {$a}.';
$string['privacy:themebiossexsettings_enableaccessibilitytoolbar'] = 'A preferência atual para habilitar a barra de acessibilidade é para exibi-lá';
