...
$string['pluginname'] = 'biossex';
$string['configtitle'] = 'biossex';
...
$string['PuestoDesc'] = 'Campo Puesto';
$string['PuestoText'] = 'Seleccione el campo que contendra la información de puesto del empleado';
...
$string['slidercaption'] = 'Descripción de la imagen';
...
$string['privacy:metadata:preference:themebiossexsettings_fonttype'] = 'The user\'s preference for font type.';
$string['privacy:metadata:preference:themebiossexsettings_enableaccessibilitytoolbar'] = 'The user\'s preference for enable the accessibility toolbar.';
...
$string['privacy:themebiossexsettings_fonttype'] = 'The current preference for the font type is: {$a}.';
$string['privacy:themebiossexsettings_enableaccessibilitytoolbar'] = 'The current preference for enable accessibility toolbar is to show it.';

//Plan de Capacitación
$string['PlanCapacitacion']='Plan de Capacitación';
$string['PlanCapacitacionDesc']='Empezar plan de capacitación o consultar información: <a href="'.$wwwroot.'/theme/biossex/pages/PlanCapacitacion.php">Ir al Plan de Capacitación</a>';

//Webinar
$string['Webinar']='Webinars';
$string['WebinarDesc']='Registrar nuevo webinar o consultar información: <a href="'.$wwwroot.'/theme/biossex/pages/webinar.php">Ir a Webinars</a>';

//Contador para las semanas del puesto
$string['countPuesto']='Seleccione las semanas para el puesto seleccionado.';
$string['countPuestodesc']='Cantidad de semanas.';

//Cursos
$string['Semana']='Seleccione Curso';
$string['CursoDesc']='Seleccione el curso para la semana.';
//Vacantes
$string['vacancies']='Vacantes';
$string['vacanciesDesc']='Imagen para la vacante.';

//Url vacantes refiere
$string['refiere']='Boton Refiere';
$string['refieredesc']='Url para boton (Refiere) de vacantes.';

//Url vacantes Interna
$string['interna']='Boton Postulación Interna';
$string['internadesc']='Url para boton (Postulación Interna) de vacantes.';

//Texto Welcome
$string['TextoWelcome']='Texto';
$string['WelcomeDesc']='Texto de Bienvenida.';

//Video Welcome
$string['VideoWelcome']='Video';
$string['VideoWelcomeDesc']='Video de Bienvenida.';

//Texto para la portada de slider
$string['TextoPortadaSlider']='Texto';
$string['TextoPortadaSliderDesc']='Ingrese el texto para la portada del slider.';

//Texto para la portada de slider
$string['ImagenPortadaSlider']='Imagen';
$string['ImagenPortadaSliderDesc']='Imagen para la portada del slider.';

//Texto para la imagen del carrucel webinars
$string['ImagenWebinar']='Imagen';
$string['ImagenWebinarDesc']='Imagen para Webinars.';

//Url para el link de las imagenes
$string['UrlImage']='Url';
$string['UrlImageDesc']='Url de la imagen.';

//Select para las vacantes
$string['countvacant']='Seleccione cantidad de vacantes';
$string['countvacantDesc']='Vacantes disponibles';

//Imagenes de las vacantes
$string['imagevacante']='Imagen';
$string['imagevacantedesc']='Imagen para la portada de la vacante.';

//Titulo de las vacante
$string['imagetitle']='Título';
$string['imagetitledesc']='Ingrese título de la vacante.';

//Descripción de las vacantes
$string['imagedescripcion']='Descripción';
$string['imagedescripciondesc']='Descripción de la vacante.';

//Podcast dinamico
$string['urlpodcast']='Url del podcast';
$string['urlpodcastdesc']='Ingrese el url de spotify.';

//Saludos de Bienvenida
$string['unaSemana']='Ultimo ingreso 1 semana despúes';
$string['unaSemanadesc']='Ingrese el saludo (1 semana).';

$string['dosSemanas']='Ultimo ingreso 2 semanas después ';
$string['dosSemanasdesc']='Ingrese el saludo (2 semanas).';

$string['tresSemanas']='Ultimo ingreso 3 semanas después';
$string['tresSemanasdesc']='Ingrese el saludo (3 semanas).';

$string['cuatroSemanas']='Ultimo ingreso 4 semanas después ';
$string['cuatroSemanasdesc']='Ingrese el saludo (4 semanas).';

$string['cincoSemanas']='Ultimo ingreso 5 semanas después ';
$string['cincoSemanasdesc']='Ingrese el saludo (5 semanas).';

//Ocultar podcast
$string['ViewPodcast']='Ocultar Podcast';
$string['ViewPodcastDesc']='Marque si desea ocultar el Podcast.';

$string['capacitacion_mobile'] = 'Plan de Capacitación biossex';

//Configuración para el bloque birthday
$string['Birthday']='Imagen de cumpleaños.';
$string['BirthdayDesc']='Seleccione una imagen de su preferencia que aparecerá en el bloque de cumpleaños.';
