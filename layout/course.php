...
$coursepresentation = theme_biossex_get_setting('coursepresentation');
...
if (!$coursepresentation || $coursepresentation == 1) {
    echo $OUTPUT->render_from_template('theme_biossex/columns2', $templatecontext);
} else if ($coursepresentation == 2) {
    echo $OUTPUT->render_from_template('theme_biossex/course_cover', $templatecontext);
}
