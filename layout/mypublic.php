...
$usercourses = \theme_biossex\util\extras::user_courses_with_progress($user);
...
$templatecontext['user']->profilepicture = \theme_biossex\util\extras::get_user_picture($user, 100);
$templatecontext['user']->fullname = fullname($user);

$competencyplans = \theme_biossex\util\extras::get_user_competency_plans($user);
$templatecontext['hascompetencyplans'] = (count($competencyplans)) ? true : false;
$templatecontext['competencyplans'] = $competencyplans;

$templatecontext['headerbuttons'] = \theme_biossex\util\extras::get_mypublic_headerbuttons($context, $user);

echo $OUTPUT->render_from_template('theme_biossex/mypublic', $templatecontext);
